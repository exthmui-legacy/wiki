...
{% include alerts/note.html content="This method requires that your device is [rooted](https://download.exthmui.cn/exthmui/extras), which is only officially supported up through exTHmUI 9, users of 10 or above will need to use a computer." %}
